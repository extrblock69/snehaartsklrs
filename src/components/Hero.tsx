      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 w-full">
        ...
        <div className="lg:col-span-7 text-left space-y-6">
          ...
          <motion.div
            ...
            className="grid grid-cols-3 gap-4 pt-10 border-t border-stone-200 dark:border-stone-900 max-w-lg"
          >
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1.5 text-stone-900 dark:text-stone-100 font-serif text-2xl font-semibold">
                <BookOpen className="w-5 h-5 stroke-[1.5] text-wood" />
                <span>24+</span>
              </div>
              <p className="text-[11px] font-mono tracking-wider text-stone-500 dark:text-stone-400 uppercase">
                Solo Expositions
          ...
          >
            ...
            <div className="relative w-full h-[82%] overflow-hidden rounded-md bg-stone-200 dark:bg-stone-800">
              <img
                ...
                alt="Artist Sneha Sketching"
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,rgba(0,0,0,0.4),transparent)] pointer-events-none" />

              {/* Float drawing paper tag */}
              <div className="absolute bottom-4 left-4 bg-stone-900/80 backdrop-blur-sm text-stone-50 px-3 py-1 rounded text-[10px] font-mono tracking-widest uppercase">
